...
#
# When running gammas incident on the converter, many gammas pass straight
# through.  The large amount of extrusions weighs heavily on Blender.
# Eventually, I'll implement a trajectory filter in Geant4.  Until then,
# I run a little awk script (stupid_strip.sh) to manually remove the
# straight-through gammas.
#
...
obj.rotation_euler = [1.0472, 0.0, 0.523599]
